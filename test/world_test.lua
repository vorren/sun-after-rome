...
return {
  ...
  ["test-spawn-entity"] = function()
    ...
    luaunit.assertTrue(world.world_has_q(w, id, "kind"))
    luaunit.assertTrue(world.world_has_q(w, id, "position"))
    luaunit.assertTrue(world.world_has_q(w, id, "owner"))
    luaunit.assertTrue(world.world_has_q(w, id, "health"))
    luaunit.assertTrue(world.world_has_q(w, id, "carry"))
    luaunit.assertTrue(world.world_has_q(w, id, "task"))
  end,
  ...
  ["test-remove-entity"] = function()
    ...
    local id = world.spawn_bang(w, "villager", {owner = 0, x = 5, y = 5})
    luaunit.assertTrue(world.world_has_q(w, id, "kind"))
    world.world_remove_entity_bang(w, id)
    luaunit.assertFalse(world.world_has_q(w, id, "kind"))
  end,
